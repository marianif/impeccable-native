...
version: 0.10.0
user-invocable: true
argument-hint: "[craft|teach|document|extract|adapt|animate|audit|bolder|clarify|colorize|critique|delight|distill|harden|onboard|layout|optimize|overdrive|polish|quieter|rethink|break|flow|migration|rebrand|design-system|shape|typeset] [target]"
...
allowed-tools:
  ...
  - Bash(node {{scripts_path}}/design-system/detect-layout.mjs *)
  - Bash(node {{scripts_path}}/design-system/cache-check.mjs *)
  - Bash(node {{scripts_path}}/design-system/inventory.mjs *)
  - Bash(node {{scripts_path}}/design-system/charter-bootstrap.mjs *)
  - Bash(node {{scripts_path}}/design-system/charter-stamp.mjs *)
  - Bash(node {{scripts_path}}/design-system/join.mjs *)
  - Bash(node .impeccable/design-system/state.mjs *)
  - Bash(node .impeccable/design-system/mapper.mjs *)
