...
version: 0.9.0
user-invocable: true
argument-hint: "[craft|teach|document|extract|adapt|animate|audit|bolder|clarify|colorize|critique|delight|distill|harden|onboard|layout|optimize|overdrive|polish|quieter|rethink|break|flow|migration|rebrand|shape|typeset] [target]"
