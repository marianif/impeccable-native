...
```bash
node .cursor/skills/impeccable-native/scripts/design-system/design-system-scan.mjs --dir=. [--brief=.impeccable/brand-brief.json]
```
...
```bash
node .cursor/skills/impeccable-native/scripts/design-system/validate-plan.mjs --plan=.impeccable/design-system-plan.json
```
