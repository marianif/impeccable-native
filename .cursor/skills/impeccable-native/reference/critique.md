...
Before assessing: confirm the flavor detector has run for this session (`node .cursor/skills/impeccable-native/scripts/detect-rn-flavor.mjs`) and that `load-context.mjs` has surfaced PRODUCT.md + DESIGN.md. `Platform Fidelity` and `Primary Devices` from PRODUCT.md set the bar for what counts as a finding.
...
2. **Compute the slug**:
   ```bash
   node .cursor/skills/impeccable-native/scripts/critique-storage.mjs slug "<resolved-path>"
   ```
...
```bash
node .cursor/skills/impeccable-native/scripts/screenshot.mjs --platform ios --slug <slug>
node .cursor/skills/impeccable-native/scripts/screenshot.mjs --platform android --slug <slug>
```
...
```bash
node .cursor/skills/impeccable-native/scripts/a11y-audit.mjs --json <target>
node .cursor/skills/impeccable-native/scripts/platform-parity.mjs --json <target>
node .cursor/skills/impeccable-native/scripts/extract-tokens.mjs --json --dry-run <target>
```
...
- **Suggested command**: which impeccable-native command could address this (from: /impeccable adapt, /impeccable animate, /impeccable audit, /impeccable bolder, /impeccable break, /impeccable clarify, /impeccable colorize, /impeccable craft, /impeccable critique, /impeccable delight, /impeccable distill, /impeccable document, /impeccable extract, /impeccable flow, /impeccable harden, /impeccable layout, /impeccable migration, /impeccable onboard, /impeccable optimize, /impeccable overdrive, /impeccable polish, /impeccable quieter, /impeccable rebrand, /impeccable rethink, /impeccable shape, /impeccable teach, /impeccable typeset)
...
2. **Pass the structured metadata** through `IMPECCABLE_CRITIQUE_META` (JSON), then run the write command:
   ...
   IMPECCABLE_CRITIQUE_META='{"target":"<user phrasing>","total_score":<n>,"p0_count":<n>,"p1_count":<n>,"platforms":["ios","android"]}' \
     node .cursor/skills/impeccable-native/scripts/critique-storage.mjs write <slug> <body-file>
   ```
...
4. **Read the trend** for context:
   ```bash
   node .cursor/skills/impeccable-native/scripts/critique-storage.mjs trend <slug> 5
   ```
...
- Only recommend commands from: /impeccable adapt, /impeccable animate, /impeccable audit, /impeccable bolder, /impeccable break, /impeccable clarify, /impeccable colorize, /impeccable craft, /impeccable critique, /impeccable delight, /impeccable distill, /impeccable document, /impeccable extract, /impeccable flow, /impeccable harden, /impeccable layout, /impeccable migration, /impeccable onboard, /impeccable optimize, /impeccable overdrive, /impeccable polish, /impeccable quieter, /impeccable rebrand, /impeccable rethink, /impeccable shape, /impeccable teach, /impeccable typeset
