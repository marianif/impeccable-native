...
```bash
node {{scripts_path}}/design-system/design-system-scan.mjs --dir=. [--brief=.impeccable/brand-brief.json]
```
...
```bash
node {{scripts_path}}/design-system/validate-plan.mjs --plan=.impeccable/design-system-plan.json
```
