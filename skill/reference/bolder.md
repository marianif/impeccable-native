...
If any of these are unclear from PRODUCT.md / DESIGN.md, {{ask_instruction}}
...
When the result feels right on both iOS and Android, hand off to `{{command_prefix}}impeccable-native polish` for the final pass.
