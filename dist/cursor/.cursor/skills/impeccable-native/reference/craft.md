...
Look at what you built like a designer would. Your eyes are whatever the harness gives you: iOS Simulator, Android Emulator, a physical device via Expo Go or a dev build, `node .cursor/skills/impeccable-native/scripts/screenshot.mjs`, Maestro, Detox, or asking the user.
